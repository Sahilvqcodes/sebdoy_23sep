...
class Profile extends StatefulWidget {
  Post? post;
  User? user;
  Profile(this.post, this.user, {Key? key}) : super(key: key);
...
class _ProfileState extends State<Profile> with SingleTickerProviderStateMixin {
  ...
  getUserDetails() async {
    User userProfile = await _authMethods.getUserProfileDetails(id);
    setState(() {
                          ...
                          child: TabBar(
                            ...
                            tabs: [
                              ...
                              StreamBuilder(
                                  stream: FirebaseFirestore.instance
                                      .collection('posts')
                                      .where('plus', arrayContains: (id))
                                      .snapshots(),
                                  builder: (content, snapshot1) {
                                    return StreamBuilder(
                                        stream: FirebaseFirestore.instance
                                            .collection('posts')
                                            .where('minus', arrayContains: (id))
                                            .snapshots(),
                            ...
                            return StreamBuilder(
                              stream: CombineLatestStream.list([
                                FirebaseFirestore.instance
                                    ...
                                    // .doc()
                                    // .collection('comments')
                                    .where('allVotesUIDs', arrayContains: (id))
                                    .snapshots(),
                                FirebaseFirestore.instance
                                    .collection('polls')
                                    // .doc()
